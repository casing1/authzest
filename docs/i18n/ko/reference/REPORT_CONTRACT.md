...
[v0.1.0-alpha.2](https://github.com/casing1/authzest/releases/tag/v0.1.0-alpha.2)에 도입하고 공개된
[v0.1.0-alpha.3](https://github.com/casing1/authzest/releases/tag/v0.1.0-alpha.3)와 이 소스에서도
변경 없이 유지하는 스키마 **1.2**를 설명합니다. 첫 alpha.1 바이너리는 기존 무버전 목록을 사용합니다.
리포트 스키마 버전은 패키지 버전 `0.1.0a3`와 별개입니다. [릴리스 기록](../releases/RELEASING.md)을
